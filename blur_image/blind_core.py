...
from image_processing.blind_richardson_lucy import BlindRichardsonLucy
...
class BlindImageProcessor:
    ...
    def process_image(self, image_path, kernel_obj, iterations, psf_iterations):
        ...
        blrl = BlindRichardsonLucy(image, kernel_obj.kernel, iterations, psf_iterations)
...
if __name__ == "__main__":
    input_folder = "blind_originals"
    output_folder = "blind_processed"
